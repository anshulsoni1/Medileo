  ...
  return (
    <>
      ...
      <main className="w-full">
        {/* ─── Hero ─── */}
        <section className="hero-gradient-products text-white pt-32 pb-40 relative overflow-hidden">
          <div className="absolute inset-0 dot-grid-bg opacity-10 pointer-events-none" aria-hidden="true" />
          <div className="max-w-[1280px] mx-auto w-full px-6 relative z-10 text-center">
            <h1
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {products.map((p, i) => (
                  <article
                    ...
                    className="bg-white rounded-[12px] p-6 md:p-8 shadow-[0_10px_30px_rgba(0,21,43,0.05)] border border-(--color-surface-variant) hover:shadow-[0_15px_40px_rgba(0,21,43,0.12)] hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group reveal-item card-hover"
                  ...
                  >
                    ...
                    <div className="bg-(--color-surface-container-low) rounded-lg p-4 border-l-4 border-(--color-navy-deep)">
                      <p
                    ...
                    <div className="w-full h-px bg-(--color-surface-variant) my-4" />
                    <p
        ...
        <section className="pb-20">
          <div className="max-w-[1280px] mx-auto w-full px-6">
            <div className="w-full bg-(--color-surface-container-lowest) border border-(--color-outline-variant) border-dashed rounded-xl p-6 md:p-8 text-center shadow-sm">
