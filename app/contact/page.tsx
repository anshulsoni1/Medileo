  ...
  return (
    <>
      ...
      <main className="w-full">
        {/* ─── Hero ─── */}
        <section className="hero-gradient-lr text-white pt-28 pb-40 relative overflow-hidden flex flex-col items-center justify-center text-center w-full">
          ...
          <div className="max-w-[1280px] mx-auto w-full px-6 relative z-10 flex flex-col items-center justify-center text-center">
            <div className="max-w-[768px] mx-auto w-full text-center flex flex-col items-center justify-center gap-5 px-4 md:px-0">
              <h1
          ...
          <div className="max-w-[1280px] mx-auto w-full px-6">
            <ScrollRevealWrapper className="w-full">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch w-full">
                {/* Left – info cards */}
                <div className="lg:col-span-6 flex flex-col gap-6 lg:gap-8 w-full pb-0">
                  {/* Office Card */}
                  <div className="glass-panel rounded-[12px] p-6 md:p-8 shadow-[0px_10px_30px_rgba(0,21,43,0.05)] border-l-4 border-(--color-navy-deep) hover:-translate-y-1 transition-transform duration-300 reveal-item card-hover delay-0 flex-1 flex flex-col justify-center">
                  ...
                  {/* Email Card */}
                  <div className="glass-panel rounded-[12px] p-6 md:p-8 shadow-[0px_10px_30px_rgba(0,21,43,0.05)] border-l-4 border-(--color-status-success) hover:-translate-y-1 transition-transform duration-300 reveal-item card-hover delay-100 flex-1 flex flex-col justify-center">
                    <div className="w-12 h-12 bg-(--color-surface-container) rounded-full flex items-center justify-center mb-4 text-2xl flex-shrink-0">
                      ✉️
                    </div>
                    <h3
                ...
                <div className="lg:col-span-6 reveal-item delay-200 w-full">
                  <div className="glass-panel rounded-[12px] p-6 md:p-8 shadow-[0px_10px_30px_rgba(0,21,43,0.05)] h-full">
                    <h2
        ...
        <section className="pb-20">
          <div className="max-w-[1280px] mx-auto w-full px-6">
            <ScrollRevealWrapper>
              <div className="w-full bg-(--color-surface-container-lowest) border border-(--color-outline-variant) border-dashed rounded-2xl p-6 md:p-8 text-center shadow-sm reveal-item">
